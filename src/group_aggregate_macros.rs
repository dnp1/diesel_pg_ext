...
macro_rules! define_ordered_aggregate {
    (
        ...
        // ── Diesel Traits (Diesel 2.x compliant) ─────────────────────────────
        $(
            impl<$($ty),*> diesel::expression::Expression for $Struct<$($ty),*> where E: diesel::expression::Expression, E::SqlType: SingleValue { type SqlType = $ret_type; }
            impl<$($ty),*, QS: ?Sized> diesel::expression::AppearsOnTable<QS> for $Struct<$($ty),*> where E: diesel::expression::AppearsOnTable<QS>, $($O: diesel::expression::AppearsOnTable<QS>,)* E::SqlType: SingleValue {}
            impl<$($ty),*, QS: ?Sized> diesel::expression::SelectableExpression<QS> for $Struct<$($ty),*> where E: diesel::expression::SelectableExpression<QS>, $($O: diesel::expression::SelectableExpression<QS>,)* E::SqlType: SingleValue, Self: diesel::expression::AppearsOnTable<QS> {}
            impl<$($ty),*, GB> diesel::expression::ValidGrouping<GB> for $Struct<$($ty),*> where E: diesel::expression::ValidGrouping<GB>, $($O: diesel::expression::ValidGrouping<GB>,)* E::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
        )*

        // Workaround for macro hygiene: explicit impls per struct
        ...
        impl<E, GB> diesel::expression::ValidGrouping<GB> for $Base<E> where E: diesel::expression::ValidGrouping<GB>, E::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
        ...
        impl<E, O, GB> diesel::expression::ValidGrouping<GB> for $Ordered<E, O> where E: diesel::expression::ValidGrouping<GB>, O: diesel::expression::ValidGrouping<GB>, E::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
        ...
        impl<E, GB> diesel::expression::ValidGrouping<GB> for $Distinct<E> where E: diesel::expression::ValidGrouping<GB>, E::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
        ...
        impl<E, O, GB> diesel::expression::ValidGrouping<GB> for $DistinctOrdered<E, O> where E: diesel::expression::ValidGrouping<GB>, O: diesel::expression::ValidGrouping<GB>, E::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
...
macro_rules! define_ordered_aggregate_2_args {
    (
        ...
        impl<E1, E2, GB> diesel::expression::ValidGrouping<GB> for $Base<E1, E2> where E1: diesel::expression::ValidGrouping<GB>, E2: diesel::expression::ValidGrouping<GB>, E1::SqlType: SingleValue, E2::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
        ...
        impl<E1, E2, O, GB> diesel::expression::ValidGrouping<GB> for $Ordered<E1, E2, O> where E1: diesel::expression::ValidGrouping<GB>, E2: diesel::expression::ValidGrouping<GB>, O: diesel::expression::ValidGrouping<GB>, E1::SqlType: SingleValue, E2::SqlType: SingleValue { type IsAggregate = diesel::expression::is_aggregate::Yes; }
